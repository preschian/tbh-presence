...
internal static class GameInterop
{
    ...
    // Box inventory singleton (currently `bbd` @1.2.8, was `bav` @1.02.04): static self-property + instance
    ...
    // (currently `bbs` @1.2.8, was `baf` @1.01.05) is obfuscated. BepInEx interop exposes
    ...
    // (currently `bde` @1.2.8, was `bcq` @1.02.04): a MonoBehaviour singleton that
